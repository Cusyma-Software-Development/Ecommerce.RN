...
namespace Grand.Web.Areas.Admin.Controllers
{
    ...
    public class ReportsController : BaseAdminController
    {
        ...
        protected virtual async Task<IList<OrderPeriodReportLineModel>> GetReportOrderPeriodModel()
        {
            ...
            var reportperiod7days = await _orderReportService.GetOrderPeriodReport(7, _workContext.CurrentCustomer.StoreId);
            ...
            var reportperiod14days = await _orderReportService.GetOrderPeriodReport(14, _workContext.CurrentCustomer.StoreId);
            report.Add(new OrderPeriodReportLineModel
            {
            ...
            var reportperiodmonth = await _orderReportService.GetOrderPeriodReport(30, _workContext.CurrentCustomer.StoreId);
            report.Add(new OrderPeriodReportLineModel
            {
            ...
            var reportperiodyear = await _orderReportService.GetOrderPeriodReport(365, _workContext.CurrentCustomer.StoreId);
            report.Add(new OrderPeriodReportLineModel
            {
