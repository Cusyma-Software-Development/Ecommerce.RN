...
namespace Grand.Framework.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IMvcBuilder AddGrandMvc(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            mvcBuilder.AddFluentValidation(configurations =>
            {
                var assemblies = mvcBuilder.PartManager.ApplicationParts
                    .OfType<AssemblyPart>()
                    .Where(part => part.Name.StartsWith("Grand", StringComparison.InvariantCultureIgnoreCase))
                    .Select(part => part.Assembly);
                configurations.RegisterValidatorsFromAssemblies(assemblies);
                configurations.RunDefaultMvcValidationAfterFluentValidationExecutes = false;
                //implicit/automatic validation of child properties
                configurations.ImplicitlyValidateChildProperties = true;
            });
