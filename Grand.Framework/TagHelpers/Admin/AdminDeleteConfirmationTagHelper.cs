...
{
    [HtmlTargetElement("admin-confirmation")]
    public partial class AdminConfirmationTagHelper : TagHelper
    {
        [ViewContext]
        ...
        public AdminConfirmationTagHelper(IHtmlHelper htmlHelper, ILocalizationService localizationService)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext tagHelperContext, TagHelperOutput output)
        {
            ...
            var windowId = new HtmlString(ViewContext.ViewData.ModelMetadata.ModelType.Name.ToLower() + "-confirmation").ToHtmlString();
