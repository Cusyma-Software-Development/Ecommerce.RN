...
{
    public class BankTransfer : BasePlugin, IPaymentMethod
    {
        private readonly ILocalizationService _localizationService;
        public BankTransfer(ILocalizationService localizationService)
        {
        ...
        {
            viewComponentName = "BankTransfer";
        }
        ...
        {
            return await Task.FromResult(_localizationService.GetResource("Plugins.Payment.BankTransfer.PaymentMethodDescription"));
        }
    }
}
