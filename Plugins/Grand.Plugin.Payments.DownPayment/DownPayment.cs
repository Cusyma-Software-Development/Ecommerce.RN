...
{
    public class DownPayment : BasePlugin,IPaymentMethod
    {
        private readonly ILocalizationService _localizationService;
        public DownPayment(ILocalizationService localizationService)
        {
        ...
        {
            return await Task.FromResult(_localizationService.GetResource("Plugins.Payment.DownPayment.PaymentMethodDescription"));
        }
    }
}
