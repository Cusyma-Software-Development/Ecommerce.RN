...
{
    public class Paynamics : BasePlugin, IPaymentMethod
    {
        private readonly ILocalizationService _localizationService;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public Paynamics(ILocalizationService localizationService, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ProcessPaymentRequest> GetPaymentInfo(IFormCollection form)
        {
            ...
            values.Add("AccountName", form["AccountName"].ToString());
            values.Add("DownPaymentAmount", form["DownPaymentAmount"].ToString());
            values.Add("Attachment", form["AttachmentName"].ToString());
            values.Add("AttachmentFile", form["AttachmentFile"].ToString());
            ProcessPaymentRequest request = new ProcessPaymentRequest();
            request.CustomValues = values;
            return await Task.FromResult(request);
        }

        public void GetPublicViewComponent(out string viewComponentName)
        {
            viewComponentName = "Paynamics";
        }
        ...
        {
            return await Task.FromResult(_localizationService.GetResource("Plugins.Payment.Paynamics.PaymentMethodDescription"));
        }
    }
